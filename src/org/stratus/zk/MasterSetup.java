...
// This class sets up the zookeeper directories: /config and
// /workers. main() takes two arguments, the host address of the
// zookeeper server to connect to (e.g., localhost:2181) and the
// initial bitcoin mining problem. /config gets set to the value of
// the latter.
//
...
// remove any extinct workers on (re)initialization, but leave active
// ones alone.
